...
void insertIntoDHT(addressInfo server, DHT_action akv) {
...
int main(int argc, char** argv) {
	...
	std::array<uint8_t, 18> return_tracker_message; // we're receiving an array of 2 addressInfo structs
	...
	insertIntoDHT(server, akv);
	insertIntoDHT(neighbor1, akv);
	insertIntoDHT(neighbor2, akv);
